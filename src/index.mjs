...
import { errorHandler, notFoundMiddleware } from "./_middleware/error-handler.mjs";
import homeRoute from "./routes/category.route.mjs";
...
app.use("/api/category", homeRoute);
